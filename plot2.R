...
#       NEI EPA data and plots total PM2.5 emissions in Baltimore City, MD
#       for 1999, 2002, 2005, and 2008 to identify whether PM2.5 emissions
#       have decreased from 1999 to 2008 in this city.
#
#
################################################################################
...
barplot(
  ...
  main = "Baltimore City, MD - Annual PM25 Emissions"
)
