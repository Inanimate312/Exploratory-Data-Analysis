...
#     NEI EPA data and plots coal-related PM2.5 emissions 
#     by type for 1999, 2002, 2005, and 2008 to identify 
#     trends in coal-related PM2.5 emissions.
#
#
################################################################################
...
# Filter to coal combustion-related sources
epa_data <- epa_data %>%
  filter(grepl("coal", Short.Name, ignore.case = TRUE) |
           grepl("coal", EI.Sector, ignore.case = TRUE) | 
           grepl("coal", SCC.Level.One, ignore.case = TRUE) |
           grepl("coal", SCC.Level.Two, ignore.case = TRUE) | 
...
barplot(
  ...
  yaxt = "n",
  xlab = "Year",
  ylab = "Coal-Related PM25 Emissions (tons)",
  main = "Coal-Related PM25 Emissions"
)
